---
title: How CI Works for R Components on Apache Arrow
author: ''
date: '2021-08-06'
slug: how-ci-works-for-r-components-on-apache-arrow
categories:
  - R
  - CI
tags:
...
On a large project like Apache Arrow which has hundreds of people simultaneously working on different implementations and library, continuous integration is really important for ensuring that changes in one part of the project don't break other parts.  I've recently been digging into the Arrow CI to learn about how it works, and I'm writing this blog post as a reminder to my future self.  In this post I'm going to be taking a file relating to the R-specific elements of Arrow and explain what the different steps do.

(go through each section with narrative next to bits of it)
