...
I’ve been meaning to blog for ages, but have been so wrapped up in project things and getting [nerd-sniped](https://xkcd.com/356/).  Here's a bit about the last 6 months.
...
3. Documentation.  At some point, I realise that the thing I’ve learned is useful to someone else and now I have to write it up properly.  To be honest, I don’t love this bit as it is a really qualitative process where I write a load of stuff, ignore it for a while and come back and fix what feels wrong, and repeat until I’m sick of editing.
